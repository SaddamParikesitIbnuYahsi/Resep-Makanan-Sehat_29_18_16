            ...
            <section class="bg-gray-800 rounded-lg p-6 shadow-lg">
                <div class="flex flex-col md:flex-row gap-12">
                    ...
                    <div class="flex-shrink-0 w-full md:w-1/3">
                        <img 
                            src="/img/Omlet Daging Ayam.jpg" 
                            alt="Omlet Daging Ayam" 
                    ...
                    <div class="w-full md:w-1/3">
                        ...
                        <ol class="list-decimal pl-6 space-y-2 text-gray-300">
                            <li>2 butir telur ayam kampung</li>
                            <li>1/2 sdm mentega</li>
                            <li>1 siung bawang putih, cincang halus</li>
                            <li>2 sdm daging ayam cincang kasar</li>
                            <li>1 helai kacang panjang, iris halus</li>
                            <li>1 sdm wortel serut halus</li>
                            <li>1 sdm jagung manis</li>
