            ...
            <section class="bg-gray-800 rounded-lg p-6 shadow-lg">
                <div class="flex flex-col md:flex-row gap-12">
                    ...
                    <div class="flex-shrink-0 w-full md:w-1/3">
                        <img 
                            src="/img/ayam black pepper.jpg" 
                            alt="Ayam Black Pepper" 
                    ...
                    <div class="w-full md:w-1/3">
                        ...
                        <ol class="list-decimal pl-6 space-y-2 text-gray-300">
                            <li>Masukkan 1 butir bawang putih geprek dan sejumput garam. Rebus potongan dada ayam hingga matang.</li>
                            <li>Goreng potongan ayam yang sudah direbus hingga berubah warna kecoklatan. Angkat dan tiriskan minyaknya.</li>
                            <li>Siapkan wajan, tumis bawang putih cincang, lalu masukkan potongan paprika merah dan aduk rata.</li>
                            <li>Masukkan potongan ayam fillet, beri saus sambal, saus tomat, saus tiram, kecap manis, garam, dan gula pasir. Aduk rata, lalu tuangkan air secukupnya hingga ayam terendam.</li>
                            <li>Koreksi rasa. Masak hingga kuah menyusut. Terakhir, masukkan potongan paprika hijau dan bawang bombay, aduk rata, dan masak sebentar. Angkat.</li>
                        </ol>
                    </div>
                </div>
            </section>
